...
namespace Calling_Methods_Assignment
{
    ...
    {
        //Create Three Metdods that take integer parameter and return an integer
        ...
        public static int Attack(int strength)
        {
            int enemy_def = 4;
            int weapon_mt = 8;
            int triangte_bonus = 1;
            int crit_coeff = 3;
            int damage = (strength + (weapon_mt + triangte_bonus) - enemy_def) * crit_coeff;
            return damage;
